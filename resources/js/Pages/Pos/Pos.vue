      ...
      <div class="row">
            ...
            <div id="items">
               <div class="row row-cols-2 row-cols-md-4">
                  <div class="col" v-for="(product, index) in products" :key="index">
                     <div class="card card-product" style="width: 250px; height: 250px;" @click="handleAddToCart(product)">
                        <span class="badge-new">10%</span>
                        <div class="img-wrap">
         ...
         <div class="col-md-4">
                     ...
                     <tbody>
                        <tr v-for="(cart, index) in carts" :key="index">
                           <td>
                              <div class="media">
                                 <div class="img-wrap">
                                    <img :src="'/uploads/products/'+ cart.image" class="img-thumbnail img-xs">
                                 </div>
                           ...
                           <td class="text-center">
                              <div class="m-btn-group m-btn-group--pill btn-group mr-2" role="group" aria-label="...">
                                 <button type="button" class="m-btn btn btn-default" @click="decreaseCartQty(index)">
                                    <i class="fa fa-minus"></i>
                                 </button>
                                 <button type="button" class="m-btn btn btn-default" disabled>{{ cart.quantity }}</button>
                                 <button type="button" class="m-btn btn btn-default" @click="increaseCartQty(index)">
                           ...
                           <td>
                              <div class="price-wrap">
                                 <var class="price">${{ formatNumber(cart.price*cart.quantity) }}</var>
                              </div>
                           </td>
                           <td class="text-right">
                              <button class="btn btn-outline-danger" @click="removeProductFromCart"> <i class="fa fa-trash"></i></button>
                           </td>
                        </tr>
                     </tbody>
                  </table>
            ...
            <div class="box">
               ...
               <dl class="dlist-align">
                  <dt>Sub Total:</dt>
                  <dd class="text-right">${{ formatNumber(total) }}</dd>
               </dl>
               <dl class="dlist-align">
                  <dt>Total: </dt>
                  <dd class="text-right h4 b"> ${{ formatNumber(total) }} </dd>
               </dl>
               <div class="row">
                  <div class="col-md-6">
                     <button type="button" @click="clearCarts" class="btn  btn-danger btn-error btn-lg btn-block"><i class="fa fa-times-circle "></i> Cancel </button>
                  </div>
                  <div class="col-md-6">
                     <button @click="handleCharge" class="btn  btn-primary btn-lg btn-block"><i class="fa fa-shopping-bag"></i> Charge
                     </button>
                  </div>
               </div>
            </div> <!-- box.// -->
