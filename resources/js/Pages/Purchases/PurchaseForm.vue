                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                 <input v-model="form.date" disabled type="text" class="form-control datetimepicker-input"
                        ...
                        <div class="row mt-5">
                           <table class="table table-bordered ">
                                 ...
                                 <tr v-for="(item, index) in cart" :key="index">
                                    ...
                                    <td style="width: 150px;">
                                       <img style="width: 100px; height: 100px;"
                                          :src="'/uploads/products/' + item.product_image" alt="photo">
                                    </td>
                              ...
                              <tfoot>
                                 ...
                                 <tr>
                                    <td colspan="8" class="text-right" style="text-align:right; font-weight:bold;">Total
                                    </td>
...
<style scoped>/* Add your component's styles here */</style>
